...
public class Player extends Ellipse2D {
	...
	public static final int OUTER_RADIUS = CANNON_LENGTH + 10;
	...
	public void draw(Graphics g) {
		...
		g2.drawArc((int) Board.ORIGIN.getX() - OUTER_RADIUS, (int) Board.ORIGIN.getY() - OUTER_RADIUS,
